Обязательно: применение React, применение препроцессора стилей, модульный подход организации кода, применение сборщика, возможность запустить готовое приложение через Docker Compose/Webpack или другой dev-сервер.
Приветствуется: чистый комментированный код (блоки логики, модули), применение TypeScript, структурированные файлы и директории (исходный код, разметка, стили).
